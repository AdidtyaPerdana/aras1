			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<select name="berpenampilan_menarik" class="form-control" required>
						...
						<option value="Tidak Menarik" <?php if($data['berpenampilan_menarik'] == 'Tidak Menarik'){ echo 'selected'; } ?>>Tidak Menarik</option>
						<option value="Kurang Menarik" <?php if($data['berpenampilan_menarik'] == 'Kurang Menarik'){ echo 'selected'; } ?>>Kurang Menarik</option>
						<option value="Cukup" <?php if($data['berpenampilan_menarik'] == 'Cukup'){ echo 'selected'; } ?>>Cukup</option>
						<option value="Menarik" <?php if($data['berpenampilan_menarik'] == 'Menarik'){ echo 'selected'; } ?>>Menarik</option>
						<option value="Sangat Menarik" <?php if($data['berpenampilan_menarik'] == 'Sangat Menarik'){ echo 'selected'; } ?>>Sangat Menarik</option>
					</select>
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<select name="menguasai_panggung" class="form-control" required>
						<option value="">-PILIH-</option>
						<option value="Tidak Baik" <?php if($data['menguasai_panggung'] == 'Tidak Baik'){ echo 'selected'; } ?>>Tidak Baik</option>
						<option value="Kurang Baik" <?php if($data['menguasai_panggung'] == 'Kurang Baik'){ echo 'selected'; } ?>>Kurang Baik</option>
						<option value="Cukup" <?php if($data['menguasai_panggung'] == 'Cukup'){ echo 'selected'; } ?>>Cukup</option>
						<option value="Baik" <?php if($data['menguasai_panggung'] == 'Baik'){ echo 'selected'; } ?>>Baik</option>
						<option value="Sangat Baik" <?php if($data['menguasai_panggung'] == 'Sangat Baik'){ echo 'selected'; } ?>>Sangat Baik</option>
					</select>
				</div>
			</div>
			<div class="form-group row">
