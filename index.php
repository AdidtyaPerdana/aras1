...
<body>
                ...
                <div class="col-lg-6 col-xl-6">
                    <div class="banner_text">
                        <div class="banner_text_iner">
	                       	<h5>E-Assessment Kelayakan Model Utusan Kontes Fashion Show Pada</h5>
                            <h1>BOESA MAMAGEMENT</h1>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <footer>
        <div class="copyright" style="margin-top:50px;margin-bottom:50px;">
            <h6 style="text-align:center;font-family:arial;font-weight: bold;">© 2020 E-Assessment</h6>
        </div>
    </footer>
    <!-- footer part end-->
